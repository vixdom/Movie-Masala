...
export function WordSearch({
  ...
  }, [getCellFromTouch, onCellMouseEnter, onCellTouchMove]);
        ...
        {grid.map((row, rowIndex) =>
          row.map((cell, colIndex) => (
            <div
              ...
              className={cn(
                'aspect-square flex items-center justify-center text-sm font-bold border border-gray-300 cursor-pointer transition-all duration-150 select-none',
