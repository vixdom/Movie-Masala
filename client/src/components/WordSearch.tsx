            ...
            <div
              ...
              className={cn(
                ...
                'hover:bg-blue-100 active:scale-95 hover:shadow-sm',
                {
                  ...
                  'bg-yellow-200 border-yellow-400 border-4': highlightedWord && cell.wordId && cell.wordId.includes(highlightedWord) && !cell.isFound,
                  'bg-white hover:bg-gray-50 border-gray-300': !cell.isSelected && !cell.isFound && !(highlightedWord && cell.wordId && cell.wordId.includes(highlightedWord)),
                }
              )}
              style={{ aspectRatio: '1' }}
              onMouseDown={(e) => {
